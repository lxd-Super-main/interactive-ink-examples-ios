...
Visit https://developer.myscript.com/ to create your MyScript Developer account and start using the library.
  ...
  s.documentation_url= 'https://developer.myscript.com/docs/interactive-ink/1.1/ios/'
  ...
  s.swift_version         = '4'   # Larry update 3.2 to 5
  ...
  s.dependency 'MyScriptInteractiveInk-Runtime', '1.2.2'
end
